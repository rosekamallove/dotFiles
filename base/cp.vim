...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 94 + 70) / 140)
exe '2resize ' . ((&lines * 15 + 32) / 65)
exe 'vert 2resize ' . ((&columns * 45 + 70) / 140)
exe '3resize ' . ((&lines * 15 + 32) / 65)
exe 'vert 3resize ' . ((&columns * 45 + 70) / 140)
exe '4resize ' . ((&lines * 15 + 32) / 65)
exe 'vert 4resize ' . ((&columns * 45 + 70) / 140)
exe '5resize ' . ((&lines * 14 + 32) / 65)
exe 'vert 5resize ' . ((&columns * 45 + 70) / 140)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
